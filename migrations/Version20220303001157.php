 ...
 */
final class Version20220303001157 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_characteristics CHANGE color color VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
